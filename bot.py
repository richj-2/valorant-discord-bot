...
def leaderboard_get(page):
    ...
    driver = webdriver.Chrome(executable_path=r'C:\Users\ijdra\OneDrive\Desktop\Code\pythoncode\discordbot\chromedriver.exe', options=options)
...
#--------------------Find player using webscraper----types in a website-----------------
...
#----------------------------bot-run---------------------------------
bot.run('NDg2MDA3MzczNDkyNzgxMDU5.W4yjow.Ccw0L970yr11FnlhjhgSnhDp8e8')